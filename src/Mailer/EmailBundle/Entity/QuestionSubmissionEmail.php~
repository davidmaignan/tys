...
/**
 * Mailer\EmailBundle\Entity\QuestionSubmissionEmail
 * @ORM\Entity
 * @ORM\Table(name="question_submission")
 */
class QuestionSubmissionEmail extends Email implements EmailInterface
{
