...
/**
 * Mailer\EmailBundle\Entity\QuestionFeedbackEmail
 * @ORM\Entity
 * @ORM\Table(name="question_feedback")
 */
class QuestionFeedbackEmail extends Email implements EmailInterface
{
