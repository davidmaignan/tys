...
use Mailer\EmailBundle\Model\EmailQuestionApprovedManager as BaseEmailQuestionApprovedManager;
use Mailer\EmailBundle\Entity\EmailInterface;
use Mailer\MailBundle\Event\EmailEventInterface;


class EmailQuestionApprovedManager extends BaseEmailQuestionApprovedManager
{
