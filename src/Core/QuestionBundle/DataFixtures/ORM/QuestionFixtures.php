...
class QuestionFixtures extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $question2->setSection($manager->merge($this->getReference('section-2')));
        ...
        $question3->setSection($manager->merge($this->getReference('section-3')));
        ...
        $question4->setSection($manager->merge($this->getReference('section-4')));
        ...
        $question5->setSection($manager->merge($this->getReference('section-5')));
        ...
        $question6->setSection($manager->merge($this->getReference('section-6')));
        ...
        $question6->setPoints(1);
        $question6->setSection($manager->merge($this->getReference('section-2')));
        $question6->setLevel($manager->merge($this->getReference('level-'.rand(1,4))));
        $question6->getTags()->add($manager->merge($this->getReference('tag-5')));
        $question6->setType($manager->merge($this->getReference('type')));
        $question6->setStatus(QuestionStatus::REVIEW);
        ...
        $question6->setPoints(1);
        $question6->setSection($manager->merge($this->getReference('section-3')));
        $question6->setLevel($manager->merge($this->getReference('level-'.rand(1,4))));
        ...
        $question6->setPoints(1);
        $question6->setSection($manager->merge($this->getReference('section-4')));
        $question6->setLevel($manager->merge($this->getReference('level-'.rand(1,4))));
        ...
        $question6->setPoints(1);
        $question6->setSection($manager->merge($this->getReference('section-5')));
        $question6->setLevel($manager->merge($this->getReference('level-'.rand(1,4))));
        $question6->getTags()->add($manager->merge($this->getReference('tag-21')));
        $question6->setType($manager->merge($this->getReference('type')));
        $manager->persist($question6);
